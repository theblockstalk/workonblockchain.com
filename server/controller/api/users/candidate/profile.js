...
module.exports.update = async function update(candidateUserId, queryBody, educationHistory, workHistory, requestUserId) {
    ...
    if (queryBody.interest_area) updateCandidateUser['candidate.interest_areas'] = queryBody.interest_area;
    ...
    if (queryBody.commercial_experience_year) updateCandidateUser['candidate.blockchain.commercial_platforms'] = queryBody.commercial_experience_year;
    if (queryBody.experimented_platform) updateCandidateUser['candidate.blockchain.experimented_platforms'] = queryBody.experimented_platform;
    if (queryBody.platforms) updateCandidateUser['candidate.blockchain.smart_contract_platforms'] = queryBody.platforms;
