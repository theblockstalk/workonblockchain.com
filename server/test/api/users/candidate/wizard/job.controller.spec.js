...
describe('add job of candidate', function () {
    ...
    describe('PUT /users/welcome/job', () => {
        ...
        userDoc.candidate.locations.should.valueOf(candidateExperience.country);
        userDoc.candidate.roles.should.valueOf(candidateExperience.roles);
        userDoc.candidate.interest_areas.should.valueOf(candidateExperience.interest_areas);
