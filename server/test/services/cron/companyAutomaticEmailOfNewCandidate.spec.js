    ...
    describe('send candidates to companies', function () {
        ...
        it('should only sent new approved candidates that are approved after the saved search is updated', async function () {
            ...
            const jobPost = {
                ...
                // visa_needed: false,
                // job_type: ["Part time"],
                positions: [profileData[0].candidate.employee.roles[0]],
                expected_salary_min: profileData[0].candidate.employee.expected_annual_salary,
                // expected_salary_max: 200000,
                currency: profileData[0].candidate.employee.currency,
                num_people_desired: 1,
                required_skills: [profileData[0].candidate.commercial_skills[0]],
                // not_required_skills:[{
                //     skills_id: skills2._id,
                //     type: skills2.type,
                //     name: skills2.name
            ...
            let resPostJob = await api.jobs.POST(companyDoc.jwt_token, null, jobPost);
            let job = resPostJob.body;
            ...
            const jobUpdate = {
                ...
                // visa_needed: false,
                // job_type: ["Part time"],
                positions: [profileData[1].candidate.employee.roles[0]],
                expected_salary_min: 200000,
                // expected_salary_max: 200000,
                currency: '$ USD',
                num_people_desired: 3,
                required_skills: [profileData[1].candidate.commercial_skills[0]],
                // not_required_skills:[{
                //     skills_id: skills2._id,
                //     type: skills2.type,
                //     name: skills2.name
            ...
            const res = await api.jobs.PATCH(jwtToken, query, jobUpdate);
