...
const endpoints = [
    ...
    require('./controller/api-v2/users/candidates/search/post.controller') //candidateFilter.controller done, verifiedCandidate.controller done, getAll.controller done
];
