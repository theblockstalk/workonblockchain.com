    ...
    getEntries(file, entries => {
      ...
      Promise.all(promises).then(() => {
       ...
       /* output.innerHTML = JSON.stringify(
        ...
        {
        	filedrag.innerHTML =
          'Dropped! Successfully upload';
        }
        else
        {
        	filedrag.innerHTML =
          'Please upload zip in proper format';
        }
        ...
        console.log(name[0]);
        this.info ={first_name :  name[0] , last_name : name[1] , contact_number : obj.basics.phone};
        //this.info.last_name = name[1];
        //this.info.contact_number= obj.basics.phone;
