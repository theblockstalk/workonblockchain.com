...
@NgModule({
  ...
  declarations: [ SafeHtmlPipe, TextValueComponent, DashboardComponent, DropdownSingleComponent],
  exports:      [ SafeHtmlPipe, CommonModule, FormsModule, TextValueComponent, DashboardComponent, DropdownSingleComponent ]
})
