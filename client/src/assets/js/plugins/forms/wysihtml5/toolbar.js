    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btne btn btn-default dropdown-toggle" + size + "' data-toggle='dropdown' href='#'>" +
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='bold' title='" + locale.emphasis.bold + "' tabindex='-1'><i class='icon-bold'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='italic' title='" + locale.emphasis.italic + "' tabindex='-1'><i class='icon-italic'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='underline' title='" + locale.emphasis.underline + "' tabindex='-1'><i class='icon-underline'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='strikeThrough' title='" + locale.emphasis.strike + "' tabindex='-1'><i class='icon-strikethrough'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='icon-list'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='icon-numbered-list'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='icon-indent-decrease'></i></a>" +
                "<a class='btne btn btn-default btn-icon" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='icon-indent-increase'></i></a>" +
              "</div>" +
            "</li>";
        },
